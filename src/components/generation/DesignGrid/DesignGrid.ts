...
import type { Cell as TCell, CellMethods } from '../DesignCell';
import Cell from '../DesignCell';
import { Grid as TGrid } from '../Grid/types';
  ...
  create() {
    ...
    for (let index = 0; index < this.cellTotal; index++) {
      ...
      const cell = new Cell({
        ...
        visitedColor: 'rgb(255,255,255,0.1)',
        backtrackColor: 'rgb(255,255,255,0.1)',
